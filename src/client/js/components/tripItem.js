...
const tripItem = (data) => {
  const currentWeatherData = data.weatherBitData.forecast
    ? data.weatherBitData.forecast[0]
    : data.weatherBitData.current;

  const forecastedWeather = data.weatherBitData.forecast
    ? `<h2 class="forecasted-weather-header">Forecasted Weather for next 16 days</h2>
        ...
        <div class="trip-item-container">
            ...
            <div class="trip-item">
                ...
                <div class="location-info">
                    <h2 class="header-with-background">Fun Facts about ${
                      data.geoNamesData.placeName
                    }</h2>
                    ${placeFunFacts({
                      placeName: data.geoNamesData.placeName,
                      ...data.countryInfo,
                    })}
                    <h2 class="header-with-background">Today's weather at ${
                      data.geoNamesData.placeName
                    }</h2>
